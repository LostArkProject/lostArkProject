...
CREATE TABLE IS_COLLECTED_POINT (
    COLLECTIBLE_TYPE_NAME VARCHAR(50),
    COLLECTIBLE_POINT_NAME VARCHAR(50),
    MEMBER_ID VARCHAR(50),
    COLLECTED_POINT INT,
    COLLECTIBLE_MAX_POINT INT,
...
CREATE TABLE MENTEE_APPLY (
    ...
    FOREIGN KEY (MENTOR_MEMBER_ID, MENTOR_CONTENT_ID) REFERENCES MENTOR(MENTOR_MEMBER_ID, MENTOR_CONTENT_ID),
    FOREIGN KEY (MENTEE_MEMBER_ID, MENTEE_CONTENT_ID) REFERENCES MENTEE(MENTEE_MEMBER_ID, MENTEE_CONTENT_ID)
);
