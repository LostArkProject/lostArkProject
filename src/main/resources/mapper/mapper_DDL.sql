...
CREATE TABLE COLLECTABLE_POINT (
    COLLECTABLE_TYPE_NAME VARCHAR(50) PRIMARY KEY,
    COLLECTABLE_ICON_LINK VARCHAR(255),
...
CREATE TABLE IS_COLLECTED_POINT (
    ...
    FOREIGN KEY(COLLECTABLE_TYPE_NAME) REFERENCES COLLECTABLE_POINT(COLLECTABLE_TYPE_NAME),
    FOREIGN KEY(MEMBER_ID) REFERENCES MEMBER(MEMBER_ID)
);
