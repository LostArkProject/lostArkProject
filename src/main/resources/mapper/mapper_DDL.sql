...
-- 수집형 포인트 테이블
CREATE TABLE COLLECTABLE_POINT (
    COLLECTABLE_TYPE_NAME VARCHAR(50),
    COLLECTABLE_POINT_NAME VARCHAR(50),
    PRIMARY KEY(COLLECTABLE_TYPE_NAME, COLLECTABLE_POINT_NAME)
);

-- 수집 테이블
CREATE TABLE IS_COLLECTED_POINT (
    COLLECTABLE_TYPE_NAME VARCHAR(50),
    COLLECTABLE_POINT_NAME VARCHAR(50),
    MEMBER_ID VARCHAR(50),
    COLLECTED_POINT INT,
    COLLECTABLE_MAX_POINT INT,
    COLLECTABLE_ICON_LINK VARCHAR(255) NOT NULL,
    PRIMARY KEY(COLLECTABLE_TYPE_NAME, COLLECTABLE_POINT_NAME, MEMBER_ID),
    FOREIGN KEY(COLLECTABLE_TYPE_NAME, COLLECTABLE_POINT_NAME) REFERENCES COLLECTABLE_POINT(COLLECTABLE_TYPE_NAME, COLLECTABLE_POINT_NAME),
    FOREIGN KEY(MEMBER_ID) REFERENCES MEMBER(MEMBER_ID)
);
...
CREATE TABLE MENTEE_APPLY (
    ...
    MENTEE_MEMBER_ID VARCHAR(50),
    MENTEE_CONTENT_ID INT,
    PRIMARY KEY (MENTOR_MEMBER_ID, MENTOR_CONTENT_ID, MENTEE_MEMBER_ID, MENTEE_CONTENT_ID),
    FOREIGN KEY (MENTOR_MEMBER_ID) REFERENCES MEMBER(MEMBER_ID),
    FOREIGN KEY (MENTOR_CONTENT_ID) REFERENCES CONTENT(CONTENT_ID),
    FOREIGN KEY (MENTEE_MEMBER_ID) REFERENCES MEMBER(MEMBER_ID),
    FOREIGN KEY (MENTEE_CONTENT_ID) REFERENCES CONTENT(CONTENT_ID)
