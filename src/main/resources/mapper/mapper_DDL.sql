...
CREATE TABLE CALENDAR(
    CALENDAR_ID BIGINT AUTO_INCREMENT PRIMARY KEY NOT NULL,
...
CREATE TABLE STARTTIME(
    START_TIME_ID BIGINT AUTO_INCREMENT PRIMARY KEY NOT NULL,
...
CREATE TABLE REWARDITEM(
    REWARD_ITEM_ID BIGINT AUTO_INCREMENT PRIMARY KEY NOT NULL,
    CALENDAR_ID BIGINT NOT NULL,
