...
CREATE TABLE MENTOR (
    ...
    FOREIGN KEY (MENTOR_CONTENT_ID) REFERENCES CONTENT(CONTENT_NUMBER) ON DELETE CASCADE
);
...
CREATE TABLE MENTEE (
    ...
    FOREIGN KEY (MENTEE_CONTENT_ID) REFERENCES CONTENT(CONTENT_NUMBER) ON DELETE CASCADE
);
