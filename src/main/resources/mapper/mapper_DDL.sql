...
CREATE TABLE COLLECTIBLE_POINT (
	MEMBER_ID VARCHAR(50) ,
    COLLECTABLE_TYPE_NAME VARCHAR(50) NOT NULL,
    COLLECTED_POINT INT NOT NULL,
    COLLECTABLE_MAX_POINT INT NOT NULL,
...
CREATE TABLE MENTOR (
    ...
    FOREIGN KEY (MENTOR_CONTENT_ID) REFERENCES CONTENT(CONTENT_ID) ON DELETE CASCADE
);
...
CREATE TABLE MENTEE (
    ...
    FOREIGN KEY (MENTEE_CONTENT_ID) REFERENCES CONTENT(CONTENT_ID) ON DELETE CASCADE
);
